        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> New Governor history&nbsp;&nbsp;
                ...
                <div class="card-block">
                    ...
                    <form 
                    	action="{{url('/governor-history/save')}}" 
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" autofocus name="name" id="name" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
